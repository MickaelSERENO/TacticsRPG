...
\subsection{Les Types}
	...
	\begin{tikzpicture}[->=stealth]
		...
		\node (Ai) at (258:3cm) [] {Entite neutre} edge [<-] (BDe);
		\node (Dr) at (309:3cm) [] {Dragons} edge [<-] (Ai);
		\draw[->] (Dr) -- (Di);
	\end{tikzpicture}
\end{center}

\subsection{Les Classes Divins (inverse des sept péchés capitaux)}
	\begin{center}
	\begin{tikzpicture}
...
\subsection{}
	\begin{center}
		\begin{tikzpicture}[->=stealth]
			\node (Co) at (0:3cm) [] {Golem};
			\node (Ai) at (51:3cm) [] {Gargoyle} edge [<-] (Co);
			\node (Fa) at (102:3cm) [] {Sanguinary beast} edge [<-] (Ai);
			\node (Se) at (155:3cm) [] {Harpy} edge [<-] (Fa);
			\node (Hi) at (207:3cm) [] {Reptilian} edge [<-] (Se);
			\node (Ch) at (258:3cm) [] {Elementary} edge [<-] (Hi);
			\node (Va) at (309:3cm) [] {Faery} edge [<-] (Ch);
			\draw[->] (Va) -- (Co);
		\end{tikzpicture}
	\end{center}
...
\subsection{Bêtes Divines}
	\begin{center}
		\begin{tikzpicture}[->=stealth]
			\node (Co) at (0:3cm)   [] {Flying};
			\node (Ai) at (51:3cm)  [align=center] {Les Géants} edge [<-] (Co);
			\node (Fa) at (102:3cm) [above] {Être celeste} edge [<-] (Ai);
			\node (Se) at (155:3cm) [align=center] {Animaux magiques\\
									  (licorne, pégase, etc.)} edge [<-] (Fa);
			\node (Hi) at (207:3cm) [] {Plante divine} edge [<-] (Se);
			\node (Ch) at (258:3cm) [below] {Chimère} edge [<-] (Hi);
			\node (Va) at (309:3cm) [] {Esprits} edge [<-] (Ch);
			\draw[->] (Va) -- (Co);
		\end{tikzpicture}
	\end{center}
...
\subsection{Bêtes Démoniaques}
	\begin{center}
		\begin{tikzpicture}[->=stealth]
		    ...
		    \node (Hi) at (207:3cm) [align=center] {Plante demoniaque} edge [<-] (Se);
			\node (Ch) at (258:3cm) [below] {Aberration} edge [<-] (Hi);
			\node (Va) at (309:3cm) [] {Orc} edge [<-] (Ch);
			\draw[->] (Va) -- (Co);
		\end{tikzpicture}
	\end{center}
